...
//                .forEach();
        ...
        Double media = lista.stream()
                ...
                .average()
                .getAsDouble();
        System.out.println("Média salarial de todos = R$" + media.shortValue());
        ...
        List<Salario> minhaLista = lista.stream()
        ...
        if (colaboradoresIdNome.containsKey(2)){
            System.out.println(colaboradoresIdNome.get(2));
        }
